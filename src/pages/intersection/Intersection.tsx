...
import img1 from '../../../public/images/gokul-gurang.jpg';
import img2 from '../../../public/images/beach.jpg';
import img3 from '../../../public/images/swimmer.jpg';
    ...
    <>
      ...
      <Container>
        ...
        <Style.ImageFullContainer>
          <img id="fullImageResize" src={img3} alt="Beach" />
        </Style.ImageFullContainer>
        <p>
